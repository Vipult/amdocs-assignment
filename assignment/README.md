...
https://github.com/Vipult/amdocs-assignment.git


2.Go to the root folder of the project i.e.assignment. 
...
Both Authorization Service and User Profile service and kafka server should start as a result of executing this command.
...
schema.sql and data.sql in User Profile Service will be loaded and USER_PROFILE TABLE will be created in H2 database. 

5.To Test the application using POSTMAN :

1.For POST :

Hit the URL: http://localhost:8085/authorization/userprofiles
Action : POST
Request Body: 
{
