/*package com.boxchain.restproxy.repository.impl;
...
@Repository
public class RestProxyConnectorImpl implements RestProxyConnector {
	
	private static final Logger logger = LoggerFactory.getLogger(RestProxyConnectorImpl.class);
